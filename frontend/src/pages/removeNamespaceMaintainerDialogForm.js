...
const RemoveNamespaceMaintainerFormDialog = ({ namespace, show, onHide }) => {
  ...
  return (
    <Modal
      ...
      onHide={onHide}
      size="md"
      aria-labelledby="remove-namespace-maintainer-modal"
      centered
      onExited={resetData}
    >
      <Form onSubmit={handleSubmit}>
        <Modal.Header closeButton>
          <Modal.Title id="remove-namespace-maintainer-modal">
            Remove Namespace Maintainer
          </Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <p className="text-muted mb-3">
            Remove a maintainer from namespace <strong>{namespace}</strong>
          </p>
